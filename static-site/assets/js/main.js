...
function initCameraDebug() {
	...
	const axes = [
		{ key: 'x',    target: 'position', min: -80,  max: 80,  step: 0.05   },
		{ key: 'y',    target: 'position', min: -40,  max: 80,  step: 0.05   },
		{ key: 'z',    target: 'position', min: -80,  max: 80,  step: 0.05   },
		{ key: 'rotY', target: 'rotation', min: -3.2, max: 3.2, step: 0.0005 },
	];
